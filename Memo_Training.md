...
## Rest API
		...
		### List existing indexes by name
			<mark>GET</mark> {{baseUrl}}/<mark>indexes</mark>?api-version=2025-09-01
		
		### Create a new index
			<mark>POST</mark> {{baseUrl}}/<mark>indexes</mark>?api-version=2025-09-01
		
		### Upload documents
			<mark>POST</mark> {{baseUrl}}/<mark>indexes</mark>/hotels-quickstart/docs/index?api-version=2025-09-01

## Python SDK

		Connect to a search service Example
			Used Classes : azure.identity.<mark>DefaultAzureCredential</mark>, azure.search.documents.indexes.<mark>SearchIndexClient</mark>
